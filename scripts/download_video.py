...
def download_video(url, output_path="./outputs", quality="best", format_type="mp4", audio_only=False):
    """
    ...
    # Output template — truncate title to 80 chars to avoid Windows path-length limits
    # (e.g. videos whose title is a long plot summary)
    cmd.extend([
        "-o", f"{output_path}/%(title).80s.%(ext)s",
